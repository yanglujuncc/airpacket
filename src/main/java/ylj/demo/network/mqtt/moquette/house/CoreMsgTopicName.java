...
public class CoreMsgTopicName {
	...
	public CoreMsgTopicName() {

	}

	public CoreMsgTopicName(int type, String userId) {
		this.type = type;
		this.userId = userId;
	}
	...
	public static CoreMsgTopicName parse(String topicNameStr) {
		...
		CoreMsgTopicName coreMsgTopicName = new CoreMsgTopicName();
	...
	public static void main(String[] args) {
		...
		System.out.println(JSON.toJSONString(CoreMsgTopicName.parse(UpTopicName), true));
		System.out.println(JSON.toJSONString(CoreMsgTopicName.parse(DownTopicName), true));
		
		CoreMsgTopicName aCoreMsgTopicName=new CoreMsgTopicName(CoreMsgTopicName.Up,"xxx");
